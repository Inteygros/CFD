...
//定义一阶导数两点向前差分
double Difference_1(double delta_x, double x){
    double result;
...
//定义一阶导数三点向前差分
double Difference_2(double delta_x, double x){
    double result;
...
//定义二阶导数三点向前差分
double Difference_3(double delta_x, double x){
    double result;
...
//定义二阶导数中心差分
double Difference_4(double delta_x, double x){
    double result;
